...
class Submenu {
	...
	private function get_submenu_icon_style() {
		...
		$size     = Mods::get( $this->component_id . '_sm_icon_size' );
		$icon_css = '';
		...
		if ( ! empty( $icon_css ) ) {
			$css .= '.nav-ul .caret svg, .nav-ul .caret img{' . $icon_css . '}';
		}
	...
	private function get_animation_style() {
		...
		switch ( $animation_type ) {
			case 'slide-up':
				$css .= '
                .nv-menu-animation-slide-up:not(.nv-mobile-menu) > .menu-item > .sub-menu,
                .nv-menu-animation-slide-up:not(.nv-mobile-menu) > .menu-item > .sub-menu .sub-menu {
                      opacity: 0;
                      visibility: hidden;
                      transform: translateY(0.5em);
                      transition: visibility .2s ease, transform .2s ease;
                }
                .nv-menu-animation-slide-up:not(.nv-mobile-menu) > .menu-item:focus > .sub-menu, .nv-menu-animation-slide-up:not(.nv-mobile-menu) > .menu-item:hover > .sub-menu, .nv-menu-animation-slide-up:not(.nv-mobile-menu) > .menu-item .menu-item:focus > .sub-menu, .nv-menu-animation-slide-up:not(.nv-mobile-menu) > .menu-item .menu-item:hover > .sub-menu {
                      opacity: 1;
                      visibility: visible;
			...
			case 'slide-down':
				$css .= '
                .nv-menu-animation-slide-down:not(.nv-mobile-menu) > .menu-item > .sub-menu,
                .nv-menu-animation-slide-down:not(.nv-mobile-menu) > .menu-item > .sub-menu .sub-menu {
                      opacity: 0;
                      visibility: hidden;
                      transform: translateY(-0.5em);
                      transition: visibility .2s ease, transform .2s ease; 
                ...
                .nv-menu-animation-slide-down:not(.nv-mobile-menu) > .menu-item:focus > .sub-menu, .nv-menu-animation-slide-down:not(.nv-mobile-menu) > .menu-item:hover > .sub-menu, .nv-menu-animation-slide-down:not(.nv-mobile-menu) > .menu-item .menu-item:focus > .sub-menu, .nv-menu-animation-slide-down:not(.nv-mobile-menu) > .menu-item .menu-item:hover > .sub-menu {
                      opacity: 1;
                      visibility: visible;
                      transform: translateY(0);
                      transition: opacity .2s ease, visibility .2s ease, transform .2s ease; 
	...
	private function get_submenu_style() {
		...
		if ( ! empty( $submenu_li_hover_css ) ) {
			$css .= '.nav-ul .sub-menu li:hover {' . $submenu_li_hover_css . '}';
		}
