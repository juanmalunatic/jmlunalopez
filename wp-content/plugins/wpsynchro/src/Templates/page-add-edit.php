<div id="wpsynchro-addedit" class="wrap wpsynchro" v-cloak>
    <h2 class="wpsynchro-page-header-title"><img src="<?= $commonfunctions->getAssetUrl("icon.png") ?>" width="35" height="35" /> WP Synchro <?= WPSYNCHRO_VERSION ?> <?php echo (\WPSynchro\CommonFunctions::isPremiumVersion() ? 'PRO' : 'FREE'); ?> - <?php ($id > 0 ? _e('Edit migration', 'wpsynchro') : _e('Add migration', 'wpsynchro')); ?></h2>
    <?php
