...
?>
        <div id="wpsynchro-run-migration" class="wrap wpsynchro" v-cloak>
            <h2 class="wpsynchro-page-header-title">
            ...
            <div class="runsync-container">
                <div class="syncsection">
                    ...
                    <div v-if="migrate_errors.length > 0">
                        <?php _e('Depending on the kind of errors, such as timeouts, it is often possible to resume the migration.', 'wpsynchro'); ?><br>
                        <?php _e('This will work most of the time, but the safest option is to start a new migration.', 'wpsynchro'); ?><br>
                        <button class="wpsynchrobutton" v-on:click="resumeMigration()"><?php _e('Resume migration', 'wpsynchro'); ?></button>
                    </div>
